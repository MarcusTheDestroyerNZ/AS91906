...
def load_main_page(frame, callbacks):
    ...
    student_management_button.place(
        relx=0.5, rely=0.25, relwidth=0.15, relheight=0.05, anchor=CENTER
    )
    view_students_button.place(
        relx=0.5, rely=0.35, relwidth=0.15, relheight=0.05, anchor=CENTER
    )
