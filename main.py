...
def clear_all_frames():
    ...
    It does this by calling the place_forget method on each frame in the
    frames dictionary. This is used to clear the current view before showing
    a new page.
    """
...
def show_frame(frame):
    """Clear all frames and show specified frame.
...
def open_student_management_page():
    """Show the student management page frame.

    This function shows the student management page frame by
    calling the show_frame function with the
    student_management_frame as an argument.
    """
    show_frame(student_management_frame)


def open_view_students_page():
    """Show the view students page frame.

    This function shows the view students page frame by calling the show_frame
    function with the view_students_frame as an argument.
    """
    show_frame(view_students_frame)


def open_edit_students_page(student=None):
    """Show the edit students page frame.

    This function shows the edit students page frame by calling the show_frame
    function with the edit_students_frame as an argument.
    """
...
def load_pages():
    ...
    and the data manager instance to manage student data.
    """
    load_view_students_page(
        view_students_frame, data_manager, view_students_callbacks
    )
